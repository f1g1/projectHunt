import { IonButton, IonCardContent, IonImg, IonItemDivider, IonLabel, IonTitle } from '@ionic/react';
    ...
    return (
        ...
        <div>  &nbsp;
            {props.step && <>
                    ...
                    <div className="ion-align-items-center" style={{ width: "100%" }}>
                        {props.step.succesResponseImage &&
                            <IonImg
                                ...
                                onClick={() => PhotoViewer.show(props.step.succesResponseImage)}></IonImg>
                        }
                    </div>
                    <IonTitle className="ion-padding-vertical ion-no-padding-start">
                        <h1>
                            {props.step.succesResponseTitle}
                        </h1>
                    </IonTitle>
                ...
                <IonButton onClick={props.handleSucces}>
                    Ok!
                    </IonButton>
            </>}

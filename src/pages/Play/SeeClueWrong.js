import { IonCardContent, IonImg, IonItemDivider, IonLabel, IonTitle } from '@ionic/react';
        ...
        <div>  &nbsp;
            {<>
                <IonTitle className="ion-text-center ion-padding-top">
                    Remaining penalty time {props.timer}
                </IonTitle>
                <IonItemDivider />
                    ...
                    <div className="ion-align-items-center" style={{ width: "100%" }}>
                        {props.step.wrongResponseImage &&
                            <IonImg
                                ...
                                onClick={() => PhotoViewer.show(props.step.wrongResponseImage)}>                            </IonImg>
                        }
                    </div>
                    <IonTitle className="ion-padding-vertical ion-no-padding-start">
                        <h1>
                            {props.step.wrongResponseTitle}
                        </h1>
                    </IonTitle>
